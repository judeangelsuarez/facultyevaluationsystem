...
(function($) {
    ...
    containerLayoutSelect.on('change', function() {
        if(this.value === "boxed") {
            ...
            if(body.attr('data-layout') === "vertical" && body.attr('data-sidebar-style') === "compact") {
    ...
    sidebarStyleSelect.on('change', function() {
        ...
        if(body.attr('data-layout') === "vertical") {
            if(body.attr('data-container') === "boxed" && this.value === "compact") {
